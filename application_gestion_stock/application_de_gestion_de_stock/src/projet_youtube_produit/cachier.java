...
payapres();        // TODO add your handling code here:
    ...
    public void cout() {
     ...
     public void subtotal() {
      ...
      public void total() {
        rs = db.executionQuery("SELECT SUM(subtotal) as subtotal FROM vente WHERE num_facture = '" + txtfac.getText() + "'");
        try {
            rs.next();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cachier(null).setVisible(true);
            }
        });
    }
